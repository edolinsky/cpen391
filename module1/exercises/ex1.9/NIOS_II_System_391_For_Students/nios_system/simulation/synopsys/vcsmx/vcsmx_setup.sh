...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_clocks_sys_pll.vo"            -work sys_pll                 
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_to_external_bus_bridge_0.v"   -work to_external_bus_bridge_0
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_sdram.v"                      -work sdram                   
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0.v"               -work nios2_qsys_0            
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_leds.v"                       -work leds                    
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_jtag_uart_0.v"                -work jtag_uart_0             
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_clocks.v"                     -work clocks                  
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/altera_up_character_lcd_communication.v"  -work character_lcd_0         
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/altera_up_character_lcd_initialization.v" -work character_lcd_0         
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_character_lcd_0.v"            -work character_lcd_0         
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_PushButtons.v"                -work PushButtons             
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/nios_system_HEX0_1.v"                     -work HEX0_1                  
