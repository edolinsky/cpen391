...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/nios_system_clocks_sys_pll.vo \
  ...
  $QSYS_SIMDIR/submodules/nios_system_to_external_bus_bridge_0.v \
  ...
  $QSYS_SIMDIR/submodules/nios_system_clocks.v \
  ...
  $QSYS_SIMDIR/submodules/nios_system_HEX0_1.v \
