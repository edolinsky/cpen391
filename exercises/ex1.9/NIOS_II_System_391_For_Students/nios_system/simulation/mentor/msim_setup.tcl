...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_clocks_sys_pll.vo"            -work sys_pll                 
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_to_external_bus_bridge_0.v"   -work to_external_bus_bridge_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_timer_0.v"                    -work timer_0                 
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_switches.v"                   -work switches                
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_sdram.v"                      -work sdram                   
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_nios2_qsys_0.v"               -work nios2_qsys_0            
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_leds.v"                       -work leds                    
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_jtag_uart_0.v"                -work jtag_uart_0             
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_clocks.v"                     -work clocks                  
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_character_lcd_communication.v"  -work character_lcd_0         
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_character_lcd_initialization.v" -work character_lcd_0         
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_character_lcd_0.v"            -work character_lcd_0         
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_PushButtons.v"                -work PushButtons             
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/nios_system_HEX0_1.v"                     -work HEX0_1                  
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L sys_pll -L rst_controller -L irq_synchronizer -L irq_mapper -L mm_interconnect_0 -L to_external_bus_bridge_0 -L timer_0 -L switches -L sdram -L nios2_qsys_0 -L leds -L jtag_uart_0 -L clocks -L character_lcd_0 -L PushButtons -L HEX0_1 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L sys_pll -L rst_controller -L irq_synchronizer -L irq_mapper -L mm_interconnect_0 -L to_external_bus_bridge_0 -L timer_0 -L switches -L sdram -L nios2_qsys_0 -L leds -L jtag_uart_0 -L clocks -L character_lcd_0 -L PushButtons -L HEX0_1 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
